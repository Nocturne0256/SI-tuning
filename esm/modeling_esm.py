...
class EsmModel(EsmPreTrainedModel):
    ...
    def forward(
        ...
        if structure is not None:
            n = extended_attention_mask.size(-1)
            repeated_mask = extended_attention_mask.repeat(1, 1, n, 1)
            extended_attention_mask = repeated_mask + structure * gamma2
        if angle is not None:
            embedding_output = embedding_output * (1 - gamma1) + angle * gamma1
